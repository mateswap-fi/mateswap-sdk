...
describe('Pair', () => {
  ...
  describe('miscellaneous', () => {
    it('getLiquidityMinted:0', async () => {
      ...
      const pair = new PairGeneric('0x1111111111111111111111111111111111111111', CurrencyAmount.fromRawAmount(tokenA, '0'), CurrencyAmount.fromRawAmount(tokenB, '0'))
    ...
    it('getLiquidityMinted:!0', async () => {
      const tokenA = new Token(568, '0x0000000000000000000000000000000000000001', 18)
      const tokenB = new Token(568, '0x0000000000000000000000000000000000000002', 18)
      const pair = new PairGeneric('0x1111111111111111111111111111111111111111',
    ...
    it('getLiquidityValue:!feeOn', async () => {
      const tokenA = new Token(568, '0x0000000000000000000000000000000000000001', 18)
      const tokenB = new Token(568, '0x0000000000000000000000000000000000000002', 18)
      const pair = new PairGeneric('0x1111111111111111111111111111111111111111', CurrencyAmount.fromRawAmount(tokenA, '1000'), CurrencyAmount.fromRawAmount(tokenB, '1000'))
