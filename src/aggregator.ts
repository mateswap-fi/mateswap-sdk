...
import { TradeWalker } from './entities/TradeWalker'
 ...
 */
export interface TradeWalkerOptions {
  /**
...
export interface TradeWalkerOptionsDeadline extends Omit<TradeWalkerOptions, 'ttl'> {
  /**
...
export abstract class Aggregator {
  ...
  public static swapCallParameters(
    trade: TradeWalker<Currency, Currency>,
    options: TradeWalkerOptions | TradeWalkerOptionsDeadline
  ): SmartSwapParameters {
